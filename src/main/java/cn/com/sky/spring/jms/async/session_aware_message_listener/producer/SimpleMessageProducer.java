package cn.com.sky.spring.jms.async.session_aware_message_listener.producer;
...
//                    LOG.error("Sending request message number '{}'", count);
                    LOG.error("Sending request message: [{}]",payload);
                    return message;
                }
            });
        }
