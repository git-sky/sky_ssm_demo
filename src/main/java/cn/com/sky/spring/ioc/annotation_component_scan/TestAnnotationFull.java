package cn.com.sky.spring.ioc.annotation_component_scan;
 ...
 * <pre>
 *
 *  <context:annotation-config> 相当于 autowire + setter/getter方法
 *  <context:component-scan> + @Component 相当于<context:annotation-config> + <bean>定义
 *
 *
 *
...
public class TestAnnotationFull {
    ...
    public static void main(String[] args) {
        ...
        String configLocation = getPath() + "/annotation_component_scan.xml";
