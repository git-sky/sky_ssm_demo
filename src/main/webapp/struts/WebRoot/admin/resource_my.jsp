...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
	     <td>
	     		<s:set name="curPage" value="%{requestScope.curPage}"></s:set>
				<s:set name="totalPage" value="%{requestScope.totalPage}"></s:set>
						...
						<td>
							...
							资源类型：
									...
									<s:select name="resourcetypeid" list="alltype"
										listKey="#request.resourcetypeid" listValue="#request.resourcetypename"
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
	      <tr>
	        <td width="20%" height="25" background="images/01.gif"><div align="center"><span class="STYLE10">资源名称</span></div></td>
	        <td width="20%" height="25" background="images/01.gif"><div align="center"><span class="STYLE10">资源类型</span></div></td>
	 	    <td width="20%" height="25" background="images/01.gif"><div align="center"><span class="STYLE10">下载次数</span></div></td>
	        <td width="20%" height="25" background="images/01.gif"><div align="center"><span class="STYLE10">上传日期</span></div></td>
	        <td width="20%" height="25" background="images/01.gif"><div align="center"><span class="STYLE10">基本操作</span></div></td>
	      </tr>
	    	<s:iterator value="#request.all" id="resource">
	      <tr>
			<td height="30" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19">		<a href="showResource?resourceid=<s:property value='#resource.resourceid'/>"><s:property
		 ...
		 <td colspan="8"  height="25"  background="images/01.gif"><div align="center"><span class="STYLE10">
