...
<div id="main">
	...
	<div id="main2" class="main2">	
		<table width="60%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td height="40px">
					<a href="chapter_add.jsp" style="text-decoration: none; font-size: 12px;" >--添加章节--</a>
				</td>
	        </tr>	
			<tr>
				<td>
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<s:iterator value="#request.all" id="chapter">
							<tr  align="center">
								<td height="30" bgcolor="#FFFFFF" class="STYLE19">
										<s:property value="#chapter.name" />
								</td>
								<td height="30" bgcolor="#FFFFFF">
									<a title="<s:property value="#chapter.chapterid" />"
											href="#" class="edit">修改</a> |
										<a
											href="deleteChapter?chapterid=<s:property value='#chapter.chapterid'/>" onclick="return confirm('你真的要删除吗?');">删除</a>
...
/>
					...
					<table align="center" border="0" cellpadding="0" cellspacing="3"
						...
						<tr>
							...
							<td>
								<input type="text" class="type2" id="name" name="name" size="20" />
							</td>
						</tr>
