	...
	<div id="main2" class="main2">	
		<table width="60%" border="0" align="center" cellpadding="0"
			cellspacing="0">
             <tr>
				<td height="40px">
					<a href="resourcetype_add.jsp" style="text-decoration: none; font-size: 12px;" >--添加资源类型--</a>
				</td>
	        </tr>	
			...
			<tr>
				<td>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<s:iterator value="#request.all" id="resourcetype">
							<tr  align="center">
								<td height="30" bgcolor="#FFFFFF" class="STYLE19">
										<s:property value="#resourcetype.resourcetypename" />
								</td>
								<td height="30" bgcolor="#FFFFFF">
									<a title="<s:property value="#resourcetype.resourcetypeid" />"
											href="#" class="edit">修改</a> |
										<a
											href="deleteResourcetype?resourcetypeid=<s:property value='#resourcetype.resourcetypeid'/>" onclick="return confirm('你真的要删除吗?');">删除</a>
