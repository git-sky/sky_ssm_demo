...
<html>
	...
	<body>
		...
		<form method="post" action="addArticle?a=1" onsubmit="return check();">
			<br>
				 ...
				 <td  align="center" bgcolor="#acbfd9">
					...
					<td>
						<s:select name="articletypeid" list="alltype"
							listKey="#request.articletypeid" listValue="#request.name"
							theme="simple" />
					</td>
				</tr>
				<tr bgcolor="#ffffff"  height="30">
				 <td  align="center" bgcolor="#acbfd9">
					...
					<td>
						<input type="text" size="50" id="title" name="title" style="border: solid 2px inset"/>
					</td>
				</tr>
				<tr bgcolor="#ffffff"  height="30">
				 <td  align="center" bgcolor="#acbfd9">
